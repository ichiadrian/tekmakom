...
<head>
  <meta charset="utf-8">
  <title>Tekmakom | Indonesia</title>
  ...
  <!-- Lraries CSS Files -->
  <link href="{{url('/assets/lib/nivo-slider/css/nivo-slider.css')}}" rel="stylesheet">
  <link href="{{url('/assets/lib/owlcarousel/owl.carousel.css')}}" rel="stylesheet">
  <link href="{{url('/assets/lib/owlcarousel/owl.transitions.css')}}" rel="stylesheet">
  ...
  <link href="{{url('/assets/lib/venobox/venobox.css')}}" rel="stylesheet">

  <!-- Nivo Slider Theme -->
  <link href="{{url('')}}/assets/css/nivo-slider-theme.css" rel="stylesheet">
...
<body data-spy="scroll" data-target="#navbar-example">
  ...
  <div id="home" class="slider-area">
    <div class="bend niceties preview-2">
      <div id="ensign-nivoslider" class="slides">
        <img src="{{url('')}}/assets/img/slider/slider1.jpg" alt="" title="#slider-direction-1" />
        <img src="{{url('')}}/assets/img/slider/slider2.jpg" alt="" title="#slider-direction-2" />
        <img src="{{url('')}}/assets/img/slider/slider3.jpg" alt="" title="#slider-direction-3" />
      </div>
            ...
            <div class="tab-pane active" id="p-view-1">
              <div class="tab-inner">
                <div class="event-content head-team">
                  <h4>Project</h4>
                  <p>
                    Redug Lares dolor sit amet, consectetur adipisicing elit. Animi vero excepturi magnam ducimus adipisci voluptas, praesentium maxime necessitatibus in dolor dolores unde ab, {{url('')}}/assets/libero quo. Aut, laborum sequi.
                  </p>
                  <p>
            ...
            <div class="tab-pane" id="p-view-2">
              <div class="tab-inner">
                <div class="event-content head-team">
                  ...
                  <p>
                    Redug Lares dolor sit amet, consectetur adipisicing elit. Animi vero excepturi magnam ducimus adipisci voluptas, praesentium maxime necessitatibus in dolor dolores unde ab, {{url('')}}/assets/libero quo. Aut.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="team-top">
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#">
										<img src="{{url('')}}/assets/img/team/1.jpg" alt="">
									</a>
          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#">
										<img src="{{url('')}}/assets/img/team/2.jpg" alt="">
									</a>
                <div class="team-social-icon text-center">
                  <ul>
                    <li>
          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#">
										<img src="{{url('')}}/assets/img/team/3.jpg" alt="">
									</a>
                <div class="team-social-icon text-center">
                  <ul>
                    <li>
          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#">
										<img src="{{url('')}}/assets/img/team/4.jpg" alt="">
									</a>
                <div class="team-social-icon text-center">
                  <ul>
                    <li>
      ...
      <div class="container ">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3967.097037953369!2d106.89042741434965!3d-6.117638461694152!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x5141429d7467483%3A0x35edcdf4c1145fea!2sILCS!5e0!3m2!1sid!2sid!4v1597775997555!5m2!1sid!2sid"  width="100%" height="380" frameborder="0" style="border:0" allowfullscreen></iframe>
            <!-- End Map -->
          </div>
          <!-- End Google Map -->
  ...
  <!-- JavaScript {{url('')}}/assets/Libraries -->
